...
\begin{table}[H]
\caption{Candidate tax proposals modeled in the simulations}
\label{tab:candidate_policies}
\centering
\footnotesize
\begin{tabularx}{\textwidth}{p{2.3cm} p{2.7cm} X p{2.1cm}}
\toprule
...
\addlinespace
2024 Trump & 2024 law & Extension of the individual provisions of the TCJA; elimination of taxes on Social Security benefits. & Campaign proposals \\
\addlinespace
2024 Harris & 2024 law & Expanded and fully refundable Child Tax Credit; expanded Earned Income Tax Credit. & Campaign proposals \\
\bottomrule
\end{tabularx}
\vspace{0.1cm}
\begin{minipage}{\textwidth}
\footnotesize
Notes: The table reports the provisions included in the simulations.  The detailed parameterization of each proposal is reported in Appendix \ref{app:candidate_policy_details}.  Omitted provisions are business tax provisions and proposals that cannot be mapped to the labor-income marginal tax rates used in the inverse optimal tax calculation.
\end{minipage}
\end{table}
